defmodule EBoss.Accounts.User do
  ...
  relationships do
    ...
    has_many :owned_organizations, EBoss.Organizations.Organization do
    ...
    many_to_many :organizations, EBoss.Organizations.Organization do
    ...
    has_many :sent_invitations, EBoss.Organizations.Invitation do
