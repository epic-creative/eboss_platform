defmodule EBossWeb.MixProject do
  use Mix.Project
  ...
  defp deps do
    [
      ...
      {:eboss_chat, in_umbrella: true},
      {:eboss_folio, in_umbrella: true},
      {:eboss_data, in_umbrella: true},
      {:eboss_notify, in_umbrella: true},
  ...
  defp aliases do
    [
      ...
      "assets.build": ["phoenix_vite.npm vite build --manifest --emptyOutDir true"],
