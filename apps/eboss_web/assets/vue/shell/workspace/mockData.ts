...
export const projects = [
  {
    id: "1",
    name: "API Gateway",
    description: "Stabilize edge routing and token handoff paths.",
    status: "active",
    dueAt: "2026-01-10T00:00:00Z",
    reviewAt: "2026-01-09T00:00:00Z",
    priorityPosition: 1,
    notes: "Coordinate rollout windows with platform support.",
    metadata: { cadence: "weekly", stream: "platform" },
  },
  {
    id: "2",
    name: "Dashboard UI",
    description: "Polish workspace shell interactions.",
    status: "active",
    dueAt: null,
    reviewAt: null,
    priorityPosition: 2,
    notes: null,
    metadata: { cadence: "biweekly", stream: "experience" },
  },
  {
    id: "3",
    name: "Auth Service",
    description: "Finalize MFA hardening and recovery policies.",
    status: "completed",
    dueAt: "2026-01-15T00:00:00Z",
    reviewAt: "2026-01-14T00:00:00Z",
    priorityPosition: 3,
    notes: "Postmortem complete and archived.",
    metadata: { cadence: "monthly", stream: "security" },
  },
  {
    id: "4",
    name: "Billing Engine",
    description: "Pause while payment gateway contract is renegotiated.",
    status: "on_hold",
    dueAt: "2026-01-20T00:00:00Z",
    reviewAt: null,
    priorityPosition: 4,
    notes: "Resume after legal approval.",
    metadata: { cadence: "weekly", stream: "finance" },
  },
  {
    id: "5",
